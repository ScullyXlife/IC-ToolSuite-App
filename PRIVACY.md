...
- Nitrado connection details you provide (such as API token and/or FTP settings)
- Selected Nitrado service id, platform selection, editor preferences, and tool settings

This data stays on your device unless you choose to upload configuration files to your Nitrado server.
